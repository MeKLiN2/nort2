...
class TinychatApiClient:
    def __init__(self, console):
        self.console = console
        self.tinychat_api = TinychatApi(console)

    def rtc_version(self, room):
        return self.tinychat_api.rtc_version(room)

    def connect_token(self, room):
        return self.tinychat_api.connect_token(room)

    def user_info(self, account):
        return self.tinychat_api.user_info(account)
